# ============================================================
# GEOCODING (same approach as Project 1)
# ============================================================
# Converts "Pickup Location" zone names to lat/long. Tries real
# geocoding via OpenStreetMap first; if that's unavailable, falls
# back to approximate NCR sub-region coordinates so the pipeline
# still works with zero internet dependency.
...
from src.config import GEOCODE_CACHE, PICKUP_LOCATION_COLUMN
...
def _online_geocode_all(zones):
    ...
    geolocator = Nominatim(user_agent="smartride_project3", timeout=5)
